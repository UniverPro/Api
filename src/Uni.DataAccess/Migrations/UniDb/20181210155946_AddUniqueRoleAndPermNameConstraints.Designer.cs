...
namespace Uni.DataAccess.Migrations.UniDb
{
    ...
    [Migration("20181210155946_AddUniqueRoleAndPermNameConstraints")]
    partial class AddUniqueRoleAndPermNameConstraints
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Uni.DataAccess.Models.Permission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Uni.DataAccess.Models.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Uni.DataAccess.Models.RolePermission", b =>
                {
            ...
            modelBuilder.Entity("Uni.DataAccess.Models.UserRole", b =>
                {
            ...
            modelBuilder.Entity("Uni.DataAccess.Models.RolePermission", b =>
                {
                    b.HasOne("Uni.DataAccess.Models.Permission")
                        .WithMany()
                        .HasForeignKey("PermissionId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Uni.DataAccess.Models.Role")
                        .WithMany()
            ...
            modelBuilder.Entity("Uni.DataAccess.Models.UserRole", b =>
                {
                    ...
                    b.HasOne("Uni.DataAccess.Models.User")
                        .WithMany()
